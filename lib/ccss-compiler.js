  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_Chain() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, $, chainers) {
            parser.add$($.selector);
            var chainersUnpacked = []
            chainers.forEach(function(chainer){
                chainersUnpacked = chainersUnpacked.concat(chainer);
              });
            p.addC(['chain',$.ast].concat(chainersUnpacked));
      ...
      function parse_Chainer() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, head, headExp, headEq, bridgeVal, tailEq, tail) {
            var asts = []
            ...
            */
            if (bridgeVal) {
              asts.push([headEq,head,bridgeVal])
              if (tailEq) {
                asts.push([tailEq,bridgeVal,tail])
              }
              else {
                p.error("Invalid Chain Statement",line,column)
              }      
            } else {
              asts.push([headEq,head,tail])
            }
            return asts;
          })(pos0, result0[0], result0[3], result0[5], result0[7], result0[9], result0[12]);
        }
        if (result0 === null) {
          pos = pos0;
        }
