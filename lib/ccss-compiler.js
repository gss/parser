          ...
          result0 = (function(offset, sel, v) {       
              ...
              if (sel.length !== 0) {
                ...
                switch (v) {            
                  case 'right':
                    _id1 = sel.selector + "[" + "x" + "]";
                    _id2 = sel.selector + "[" + "width" + "]";
                    parser.addVar(['var', _id1, "x", sel.ast], _id1);
                    parser.addVar(['var', _id2, "width", sel.ast], _id2);
                    parser.addVar(['varexp',id,['plus',['get',_id1],['get',_id2]], sel.ast], id);
                    break;
                  case 'bottom':
                    _id1 = sel.selector + "[" + "y" + "]";
                    _id2 = sel.selector + "[" + "height" + "]";
                    parser.addVar(['var', _id1, "y", sel.ast], _id1);
                    parser.addVar(['var', _id2, "height", sel.ast], _id2);
                    parser.addVar(['varexp',id,['plus',['get',_id1],['get',_id2]], sel.ast], id);
                    break;
                  case 'center-x':          
                  case 'centerX':
                    ...
                    parser.addVar(['var', _id1, "x", sel.ast], _id1);
                    parser.addVar(['var', _id2, "width", sel.ast], _id2);
                    parser.addVar(['varexp',id,['plus',['get',_id1],['divide',['get',_id2],2]], sel.ast], id);                       break;
                  case 'center-y':
                  case 'centerY':
                    _id1 = sel.selector + "[" + "y" + "]";
                    _id2 = sel.selector + "[" + "height" + "]";
                    ...
                    parser.addVar(['varexp',id,['plus',['get',_id1],['divide',['get',_id2],2]], sel.ast], id);                       break;
                  default:
                    parser.addVar(['var',id,v,sel.ast],id);
                }
