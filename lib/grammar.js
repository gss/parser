...
Grammar = (function() {
  ...
  Grammar.prototype._errorReporter = null;
  ...
  function Grammar(input, line, column) {
    ...
    this._commands = [];
    this._selectors = [];
    this._errorReporter = new ErrorReporter(input());
    this._line = line;
    this._column = column;
  }
  ...
  Grammar.prototype.strengthAndWeight = function() {
    ...
    return {
      ...
      invalid: function() {
        return _this._errorReporter.reportError('Invalid Strength or Weight', _this._line(), _this._column());
      }
    };
  };
  ...
  Grammar.prototype.chainer = function(options) {
    ...
    if ((bridgeValue != null) && (tailOperator != null)) {
      ...
      this._errorReporter.reportError('Invalid Chain Statement', this._line(), this._column());
    }
    return asts;
  };
