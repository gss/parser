...
Grammar = (function() {
  ...
  Grammar.prototype.strengthAndWeight = function() {
    ...
    return {
      ...
      invalid: function() {
        return Grammar._reportError('Invalid Strength or Weight', _this._input(), _this._line(), _this._column());
      }
    };
  };
  ...
  Grammar.prototype.chainer = function(options) {
    ...
    if ((bridgeValue != null) && (tailOperator != null)) {
      ...
      Grammar._reportError('Invalid Chain Statement', this._input(), this._line(), this._column());
    }
    return asts;
  };
