...
Grammar = (function() {
  ...
  Grammar.prototype._getResults = function() {
    return {
  ...
  Grammar.prototype.chainer = function(options) {
    var asts, bridgeValue, column, createChainAST, head, headAST, headCharacters, headExpression, headOperator, line, strengthAndWeight, tail, tailAST, tailCharacters, tailOperator;
    headCharacters = options.headCharacters, headExpression = options.headExpression, headOperator = options.headOperator, bridgeValue = options.bridgeValue, tailOperator = options.tailOperator, strengthAndWeight = options.strengthAndWeight, tailCharacters = options.tailCharacters, line = options.line, column = options.column;
    asts = [];
