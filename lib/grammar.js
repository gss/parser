...
Grammar = (function() {
  ...
  Grammar._reportError = function(message, input, lineNumber, columnNumber) {
    var condition, context, currentLineIndex, error, errorLocator, gutterValue, item, lastLineNumber, lineValue, lines, longestLineNumberLength, nextLineIndex, nextLineNumber, padding, previousLineIndex, previousLineNumber, _i, _len;
    error = [];
  ...
  Grammar.prototype.strengthAndWeight = function() {
    return {
      ...
      invalid: function(input, line, column) {
  ...
  Grammar.prototype.chainer = function(options) {
    var asts, bridgeValue, column, createChainAST, head, headAST, headCharacters, headExpression, headOperator, input, line, strengthAndWeight, tail, tailAST, tailCharacters, tailOperator;
    headCharacters = options.headCharacters, headExpression = options.headExpression, headOperator = options.headOperator, bridgeValue = options.bridgeValue, tailOperator = options.tailOperator, strengthAndWeight = options.strengthAndWeight, tailCharacters = options.tailCharacters, input = options.input, line = options.line, column = options.column;
    asts = [];
