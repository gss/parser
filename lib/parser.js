module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c206 = function(left) {return left;},
        peg$c207 = function(sel) {return sel;},
        peg$c208 = ",",
        ...
        peg$c226 = function(id) {return ["$virtual",id.join("")];},
        peg$c227 = function(splats, postfix) {
              return {splats:splats,postfix:postfix.join("")};
            },
        peg$c228 = { type: "other", description: "Splat" },
        peg$c229 = function(prefix, o) {
               o.prefix = prefix.join("");       
               return o;
             },
        peg$c230 = { type: "other", description: "Range" },
        peg$c231 = "...",
        peg$c232 = { type: "literal", value: "...", description: "\"...\"" },
        peg$c233 = function(from, to) {
              from = Number(from.join(''));
              to   = Number(to.join(''));
              return {from:from,to:to}
            },
        peg$c234 = function(char) {return char},
        peg$c235 = function(name) {return ["$tag",name];},
        peg$c236 = function() {return ["$tag", "*"];},
        peg$c237 = "#",
        peg$c238 = { type: "literal", value: "#", description: "\"#\"" },
        peg$c239 = function(name) {return g.splatifyIfNeeded('$id',name);},
        peg$c240 = function(name) {return g.splatifyIfNeeded('$class',name);},
        peg$c241 = function(name) {return [name];},
        peg$c242 = "&",
        ...
        peg$c247 = "::document",
        peg$c248 = { type: "literal", value: "::document", description: "\"::document\"" },
        peg$c249 = "::host",
        peg$c250 = { type: "literal", value: "::host", description: "\"::host\"" },
        peg$c251 = "::scope",
        peg$c252 = { type: "literal", value: "::scope", description: "\"::scope\"" },
        peg$c253 = "::parent",
        peg$c254 = { type: "literal", value: "::parent", description: "\"::parent\"" },
        peg$c255 = "::window",
        peg$c256 = { type: "literal", value: "::window", description: "\"::window\"" },
        peg$c257 = "::viewport",
        peg$c258 = { type: "literal", value: "::viewport", description: "\"::viewport\"" },
        peg$c259 = function() { return "::window"; },
        peg$c260 = "::this",
        peg$c261 = { type: "literal", value: "::this", description: "\"::this\"" },
        peg$c262 = "::",
        peg$c263 = { type: "literal", value: "::", description: "\"::\"" },
        peg$c264 = function() { return "&"; },
        peg$c265 = function(name, option) {
            if (option) {return ["$pseudo",name,option];}
            return ["$pseudo",name];
          },
        peg$c266 = /^[^)]/,
        peg$c267 = { type: "class", value: "[^)]", description: "[^)]" },
        peg$c268 = function(option) {return option.join(""); },
        peg$c269 = /^[^~|=!\^$&*\]]/,
        ...
        peg$c275 = function(left, op, right) {return ["$attribute",op.join(""),left.join("").trim(),right.join("").trim()]; },
        peg$c276 = function(attr) {return ["$attribute",attr.join("")]; },
        peg$c277 = function(name) {return name.join("")},
        peg$c278 = /^[a-zA-Z0-9\-_$]/,
        peg$c279 = { type: "class", value: "[a-zA-Z0-9\\-_$]", description: "[a-zA-Z0-9\\-_$]" },
        peg$c280 = { type: "other", description: "Strength and Weight" },
        peg$c281 = "!",
        peg$c282 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c283 = function(strength, weight) {
            return g.strengthAndWeight().valid(strength, weight);
          },
        peg$c284 = function() {
            return g.strengthAndWeight().invalid();
          },
        peg$c285 = function(weight) { return Number(weight.join('')); },
        peg$c286 = "required",
        peg$c287 = { type: "literal", value: "required", description: "\"required\"" },
        peg$c288 = "REQUIRED",
        peg$c289 = { type: "literal", value: "REQUIRED", description: "\"REQUIRED\"" },
        peg$c290 = "Required",
        peg$c291 = { type: "literal", value: "Required", description: "\"Required\"" },
        peg$c292 = function() { return "require"; },
        peg$c293 = "require",
        peg$c294 = { type: "literal", value: "require", description: "\"require\"" },
        peg$c295 = "REQUIRE",
        peg$c296 = { type: "literal", value: "REQUIRE", description: "\"REQUIRE\"" },
        peg$c297 = "Require",
        peg$c298 = { type: "literal", value: "Require", description: "\"Require\"" },
        peg$c299 = "strong",
        peg$c300 = { type: "literal", value: "strong", description: "\"strong\"" },
        peg$c301 = "STRONG",
        peg$c302 = { type: "literal", value: "STRONG", description: "\"STRONG\"" },
        peg$c303 = "Strong",
        peg$c304 = { type: "literal", value: "Strong", description: "\"Strong\"" },
        peg$c305 = function() { return "strong"; },
        peg$c306 = "medium",
        peg$c307 = { type: "literal", value: "medium", description: "\"medium\"" },
        peg$c308 = "MEDIUM",
        peg$c309 = { type: "literal", value: "MEDIUM", description: "\"MEDIUM\"" },
        peg$c310 = "Medium",
        peg$c311 = { type: "literal", value: "Medium", description: "\"Medium\"" },
        peg$c312 = function() { return "medium"; },
        peg$c313 = "weak",
        peg$c314 = { type: "literal", value: "weak", description: "\"weak\"" },
        peg$c315 = "WEAK",
        peg$c316 = { type: "literal", value: "WEAK", description: "\"WEAK\"" },
        peg$c317 = "Weak",
        peg$c318 = { type: "literal", value: "Weak", description: "\"Weak\"" },
        peg$c319 = function() { return "weak"; },
        peg$c320 = /^[a-zA-Z\-_]/,
        peg$c321 = { type: "class", value: "[a-zA-Z\\-_]", description: "[a-zA-Z\\-_]" },
        peg$c322 = function(strength) { return strength.join('').toLowerCase(); },
        peg$c323 = "-gss-virtual",
        peg$c324 = { type: "literal", value: "-gss-virtual", description: "\"-gss-virtual\"" },
        peg$c325 = "virtual",
        peg$c326 = { type: "literal", value: "virtual", description: "\"virtual\"" },
        peg$c327 = function(names) {
        ...
        peg$c331 = function(variables) {
              return g.stay(variables);
            },
        peg$c332 = function(variable) { return g.stayVariable(variable); },
        peg$c333 = "@-gss-stay",
        peg$c334 = { type: "literal", value: "@-gss-stay", description: "\"@-gss-stay\"" },
        peg$c335 = "@stay",
        peg$c336 = { type: "literal", value: "@stay", description: "\"@stay\"" },
        peg$c337 = function(type, selector, javaScript) {
        ...
        peg$c342 = function(characters) { return g.javaScript(characters); },
        peg$c343 = "@-gss-for-each",
        peg$c344 = { type: "literal", value: "@-gss-for-each", description: "\"@-gss-for-each\"" },
        peg$c345 = "@for-each",
        peg$c346 = { type: "literal", value: "@for-each", description: "\"@for-each\"" },
        peg$c347 = function() { return g.forLoopType().forEach(); },
        peg$c348 = "@-gss-for-all",
        peg$c349 = { type: "literal", value: "@-gss-for-all", description: "\"@-gss-for-all\"" },
        peg$c350 = "@for-all",
        peg$c351 = { type: "literal", value: "@for-all", description: "\"@for-all\"" },
        peg$c352 = function() { return g.forLoopType().forAll(); },
        peg$c353 = "-gss-",
        peg$c354 = { type: "literal", value: "-gss-", description: "\"-gss-\"" },
        peg$c355 = "chain",
        peg$c356 = { type: "literal", value: "chain", description: "\"chain\"" },
        peg$c357 = function(selector, chainers) { //sw:StrengthAndWeight?
            return g.chain(selector, chainers);
          },
        peg$c358 = /^[a-zA-Z\-_0-9]/,
        peg$c359 = { type: "class", value: "[a-zA-Z\\-_0-9]", description: "[a-zA-Z\\-_0-9]" },
        peg$c360 = function(headCharacters, headExpression, headOperator, bridgeValue, tailOperator, strengthAndWeight, tailCharacters) {
              return g.chainer({
        ...
        peg$c361 = function(operator, expression) {
            return g.headExpression(operator, expression);
          },
        peg$c362 = function(expression, operator) {
            return g.tailExpression(expression, operator);
          },
        peg$c363 = function() { return g.chainMathOperator().plus(); },
        peg$c364 = function() { return g.chainMathOperator().minus(); },
        peg$c365 = function() { return g.chainMathOperator().multiply(); },
        peg$c366 = function() { return g.chainMathOperator().divide(); },
        peg$c367 = function(operator) {
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    ...
                                    if (s16 !== peg$FAILED) {
                                      peg$reportedPos = s0;
                                      s1 = peg$c360(s1, s4, s6, s8, s10, s12, s15);
                                      s0 = s1;
                                    } else {
                                      peg$currPos = s0;
                                      s0 = peg$c0;
