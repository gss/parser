module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c147 = /^[a-zA-Z0-9#.\-_$=:+>'" \][]/,
        peg$c148 = { type: "class", value: "[a-zA-Z0-9#.\\-_$=:+>'\" \\][]", description: "[a-zA-Z0-9#.\\-_$=:+>'\" \\][]" },
        peg$c149 = "document",
        peg$c150 = { type: "literal", value: "document", description: "\"document\"" },
        peg$c151 = "host",
        peg$c152 = { type: "literal", value: "host", description: "\"host\"" },
        peg$c153 = "scope",
        peg$c154 = { type: "literal", value: "scope", description: "\"scope\"" },
        peg$c155 = "parent",
        peg$c156 = { type: "literal", value: "parent", description: "\"parent\"" },
        peg$c157 = "window",
        peg$c158 = { type: "literal", value: "window", description: "\"window\"" },
        peg$c159 = "viewport",
        peg$c160 = { type: "literal", value: "viewport", description: "\"viewport\"" },
        peg$c161 = function() { return grammar.reservedPseudoSelector().window(); },
        peg$c162 = "this",
        peg$c163 = { type: "literal", value: "this", description: "\"this\"" },
        peg$c164 = "",
        peg$c165 = function() { return grammar.reservedPseudoSelector().this(); },
        peg$c166 = "!",
        peg$c167 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c168 = function(strength, weight) {
            return grammar.strengthAndWeight().valid(strength, weight);
          },
        peg$c169 = function() {
            return grammar.strengthAndWeight().invalid();
          },
        peg$c170 = function(weight) { return grammar.weight(weight); },
        peg$c171 = "required",
        peg$c172 = { type: "literal", value: "required", description: "\"required\"" },
        peg$c173 = "REQUIRED",
        peg$c174 = { type: "literal", value: "REQUIRED", description: "\"REQUIRED\"" },
        peg$c175 = "Required",
        peg$c176 = { type: "literal", value: "Required", description: "\"Required\"" },
        peg$c177 = function() { return grammar.strength().required(); },
        peg$c178 = "require",
        peg$c179 = { type: "literal", value: "require", description: "\"require\"" },
        peg$c180 = "REQUIRE",
        peg$c181 = { type: "literal", value: "REQUIRE", description: "\"REQUIRE\"" },
        peg$c182 = "Require",
        peg$c183 = { type: "literal", value: "Require", description: "\"Require\"" },
        peg$c184 = function() { return grammar.strength().require(); },
        peg$c185 = "strong",
        peg$c186 = { type: "literal", value: "strong", description: "\"strong\"" },
        peg$c187 = "STRONG",
        peg$c188 = { type: "literal", value: "STRONG", description: "\"STRONG\"" },
        peg$c189 = "Strong",
        peg$c190 = { type: "literal", value: "Strong", description: "\"Strong\"" },
        peg$c191 = function() { return grammar.strength().strong(); },
        peg$c192 = "medium",
        peg$c193 = { type: "literal", value: "medium", description: "\"medium\"" },
        peg$c194 = "MEDIUM",
        peg$c195 = { type: "literal", value: "MEDIUM", description: "\"MEDIUM\"" },
        peg$c196 = "Medium",
        peg$c197 = { type: "literal", value: "Medium", description: "\"Medium\"" },
        peg$c198 = function() { return grammar.strength().medium(); },
        peg$c199 = "weak",
        peg$c200 = { type: "literal", value: "weak", description: "\"weak\"" },
        peg$c201 = "WEAK",
        peg$c202 = { type: "literal", value: "WEAK", description: "\"WEAK\"" },
        peg$c203 = "Weak",
        peg$c204 = { type: "literal", value: "Weak", description: "\"Weak\"" },
        peg$c205 = function() { return grammar.strength().weak(); },
        peg$c206 = "@",
        peg$c207 = { type: "literal", value: "@", description: "\"@\"" },
        peg$c208 = "-gss-virtual",
        peg$c209 = { type: "literal", value: "-gss-virtual", description: "\"-gss-virtual\"" },
        peg$c210 = "virtual",
        peg$c211 = { type: "literal", value: "virtual", description: "\"virtual\"" },
        peg$c212 = function(names) {
            return grammar.virtualElement(names);
          },
        peg$c213 = /^[^"]/,
        peg$c214 = { type: "class", value: "[^\"]", description: "[^\"]" },
        peg$c215 = function(nameCharacters) {
            return grammar.virtualElementName(nameCharacters);
          },
        peg$c216 = function(variables) {
              return grammar.stay(variables);
            },
        peg$c217 = ",",
        peg$c218 = { type: "literal", value: ",", description: "\",\"" },
        peg$c219 = function(variable) { return grammar.stayVariable(variable); },
        peg$c220 = "@-gss-stay",
        peg$c221 = { type: "literal", value: "@-gss-stay", description: "\"@-gss-stay\"" },
        peg$c222 = "@stay",
        peg$c223 = { type: "literal", value: "@stay", description: "\"@stay\"" },
        peg$c224 = "@cond",
        peg$c225 = { type: "literal", value: "@cond", description: "\"@cond\"" },
        peg$c226 = function(result) { return grammar.conditional(result); },
        peg$c227 = function(type, selector, javaScript) {
        ...
        peg$c232 = function(characters) { return grammar.javaScript(characters); },
        peg$c233 = "@-gss-for-each",
        peg$c234 = { type: "literal", value: "@-gss-for-each", description: "\"@-gss-for-each\"" },
        peg$c235 = "@for-each",
        peg$c236 = { type: "literal", value: "@for-each", description: "\"@for-each\"" },
        peg$c237 = function() { return grammar.forLoopType().forEach(); },
        peg$c238 = "@-gss-for-all",
        peg$c239 = { type: "literal", value: "@-gss-for-all", description: "\"@-gss-for-all\"" },
        peg$c240 = "@for-all",
        peg$c241 = { type: "literal", value: "@for-all", description: "\"@for-all\"" },
        peg$c242 = function() { return grammar.forLoopType().forAll(); },
        peg$c243 = "-gss-",
        peg$c244 = { type: "literal", value: "-gss-", description: "\"-gss-\"" },
        peg$c245 = "chain",
        peg$c246 = { type: "literal", value: "chain", description: "\"chain\"" },
        peg$c247 = function(selector, chainers) { //sw:StrengthAndWeight?
            grammar.chain(selector, chainers);
          },
        peg$c248 = /^[a-zA-Z\-_0-9]/,
        peg$c249 = { type: "class", value: "[a-zA-Z\\-_0-9]", description: "[a-zA-Z\\-_0-9]" },
        peg$c250 = function(headCharacters, headExpression, headOperator, bridgeValue, tailOperator, strengthAndWeight, tailCharacters) {
        ...
        peg$c253 = function() { return grammar.chainMathOperator().plus(); },
        peg$c254 = function() { return grammar.chainMathOperator().minus(); },
        peg$c255 = function() { return grammar.chainMathOperator().multiply(); },
        peg$c256 = function() { return grammar.chainMathOperator().divide(); },
        peg$c257 = function(operator) {
    ...
    function peg$parseForLooperType() {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$currPos;
        if (input.substr(peg$currPos, 13) === peg$c238) {
          s1 = peg$c238;
          peg$currPos += 13;
        } else {
          s1 = peg$FAILED;
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    ...
                                    if (s16 !== peg$FAILED) {
                                      peg$reportedPos = s0;
                                      s1 = peg$c250(s1, s4, s6, s8, s10, s12, s15);
                                      s0 = s1;
                                    } else {
                                      peg$currPos = s0;
                                      s0 = peg$c0;
