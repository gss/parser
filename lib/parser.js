module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c238 = function(id) {return ["virtual",id.join("")];},
        peg$c239 = function(splats, postfix) {
              return {splats:splats,postfix:postfix.join("")};
            },
        peg$c240 = { type: "other", description: "Splat" },
        peg$c241 = function(prefix, o) {
               o.prefix = prefix.join("");       
               return o;
             },
        peg$c242 = { type: "other", description: "Range" },
        peg$c243 = "...",
        peg$c244 = { type: "literal", value: "...", description: "\"...\"" },
        peg$c245 = function(from, to) {
              from = Number(from.join(''));
              to   = Number(to.join(''));
              return {from:from,to:to}
            },
        peg$c246 = function(char) {return char},
        ...
        peg$c353 = function(type, selector, javaScript) {
        ...
        peg$c358 = function(characters) { return g.javaScript(characters); },
        peg$c359 = "@-gss-for-each",
        peg$c360 = { type: "literal", value: "@-gss-for-each", description: "\"@-gss-for-each\"" },
        peg$c361 = "@for-each",
        peg$c362 = { type: "literal", value: "@for-each", description: "\"@for-each\"" },
        peg$c363 = function() { return g.forLoopType().forEach(); },
        peg$c364 = "@-gss-for-all",
        peg$c365 = { type: "literal", value: "@-gss-for-all", description: "\"@-gss-for-all\"" },
        peg$c366 = "@for-all",
        peg$c367 = { type: "literal", value: "@for-all", description: "\"@for-all\"" },
        peg$c368 = function() { return g.forLoopType().forAll(); },
        peg$c369 = "-gss-",
        peg$c370 = { type: "literal", value: "-gss-", description: "\"-gss-\"" },
        peg$c371 = "chain",
        peg$c372 = { type: "literal", value: "chain", description: "\"chain\"" },
        peg$c373 = function(selector, chainers) { //sw:StrengthAndWeight?
            return g.chain(selector, chainers);
          },
        peg$c374 = /^[a-zA-Z\-_0-9]/,
        peg$c375 = { type: "class", value: "[a-zA-Z\\-_0-9]", description: "[a-zA-Z\\-_0-9]" },
        peg$c376 = function(headCharacters, headExpression, headOperator, bridgeValue, tailOperator, strengthAndWeight, tailCharacters) {
              return g.chainer({
        ...
        peg$c377 = function(operator, expression) {
            return g.headExpression(operator, expression);
          },
        peg$c378 = function(expression, operator) {
            return g.tailExpression(expression, operator);
          },
        peg$c379 = function() { return g.chainMathOperator().plus(); },
        peg$c380 = function() { return g.chainMathOperator().minus(); },
        peg$c381 = function() { return g.chainMathOperator().multiply(); },
        peg$c382 = function() { return g.chainMathOperator().divide(); },
        peg$c383 = function(operator) {
    ...
    function peg$parseForLooperType() {
      ...
      s0 = peg$currPos;
      if (input.substr(peg$currPos, 14) === peg$c359) {
        s1 = peg$c359;
        peg$currPos += 14;
      } else {
        s1 = peg$FAILED;
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    ...
                                    if (s16 !== peg$FAILED) {
                                      peg$reportedPos = s0;
                                      s1 = peg$c376(s1, s4, s6, s8, s10, s12, s15);
                                      s0 = s1;
                                    } else {
                                      peg$currPos = s0;
                                      s0 = peg$c0;
