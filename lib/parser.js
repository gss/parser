module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c265 = { type: "other", description: "Strength and Weight" },
        peg$c266 = "!",
        peg$c267 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c268 = function(strength, weight) {
            return g.strengthAndWeight().valid(strength, weight);
          },
        peg$c269 = function() {
            return g.strengthAndWeight().invalid();
          },
        peg$c270 = function(weight) { return Number(weight.join('')); },
        peg$c271 = "required",
        peg$c272 = { type: "literal", value: "required", description: "\"required\"" },
        peg$c273 = "REQUIRED",
        peg$c274 = { type: "literal", value: "REQUIRED", description: "\"REQUIRED\"" },
        peg$c275 = "Required",
        peg$c276 = { type: "literal", value: "Required", description: "\"Required\"" },
        peg$c277 = function() { return "require"; },
        peg$c278 = "require",
        peg$c279 = { type: "literal", value: "require", description: "\"require\"" },
        peg$c280 = "REQUIRE",
        ...
        peg$c290 = function() { return "strong"; },
        peg$c291 = "medium",
        peg$c292 = { type: "literal", value: "medium", description: "\"medium\"" },
        peg$c293 = "MEDIUM",
        peg$c294 = { type: "literal", value: "MEDIUM", description: "\"MEDIUM\"" },
        peg$c295 = "Medium",
        peg$c296 = { type: "literal", value: "Medium", description: "\"Medium\"" },
        peg$c297 = function() { return "medium"; },
        peg$c298 = "weak",
        peg$c299 = { type: "literal", value: "weak", description: "\"weak\"" },
        peg$c300 = "WEAK",
        peg$c301 = { type: "literal", value: "WEAK", description: "\"WEAK\"" },
        peg$c302 = "Weak",
        peg$c303 = { type: "literal", value: "Weak", description: "\"Weak\"" },
        peg$c304 = function() { return "weak"; },
        peg$c305 = /^[a-zA-Z\-_]/,
        peg$c306 = { type: "class", value: "[a-zA-Z\\-_]", description: "[a-zA-Z\\-_]" },
        peg$c307 = function(strength) { return strength.join('').toLowerCase(); },
        peg$c308 = "-gss-virtual",
        peg$c309 = { type: "literal", value: "-gss-virtual", description: "\"-gss-virtual\"" },
        peg$c310 = "virtual",
        peg$c311 = { type: "literal", value: "virtual", description: "\"virtual\"" },
        peg$c312 = function(names) {
        ...
        peg$c316 = function(variables) {
              return g.stay(variables);
            },
        peg$c317 = function(variable) { return g.stayVariable(variable); },
        peg$c318 = "@-gss-stay",
        peg$c319 = { type: "literal", value: "@-gss-stay", description: "\"@-gss-stay\"" },
        peg$c320 = "@stay",
        peg$c321 = { type: "literal", value: "@stay", description: "\"@stay\"" },
        peg$c322 = function(type, selector, javaScript) {
        ...
        peg$c327 = function(characters) { return g.javaScript(characters); },
        peg$c328 = "@-gss-for-each",
        peg$c329 = { type: "literal", value: "@-gss-for-each", description: "\"@-gss-for-each\"" },
        peg$c330 = "@for-each",
        peg$c331 = { type: "literal", value: "@for-each", description: "\"@for-each\"" },
        peg$c332 = function() { return g.forLoopType().forEach(); },
        peg$c333 = "@-gss-for-all",
        peg$c334 = { type: "literal", value: "@-gss-for-all", description: "\"@-gss-for-all\"" },
        peg$c335 = "@for-all",
        peg$c336 = { type: "literal", value: "@for-all", description: "\"@for-all\"" },
        peg$c337 = function() { return g.forLoopType().forAll(); },
        peg$c338 = "-gss-",
        peg$c339 = { type: "literal", value: "-gss-", description: "\"-gss-\"" },
        peg$c340 = "chain",
        peg$c341 = { type: "literal", value: "chain", description: "\"chain\"" },
        peg$c342 = function(selector, chainers) { //sw:StrengthAndWeight?
            return g.chain(selector, chainers);
          },
        peg$c343 = /^[a-zA-Z\-_0-9]/,
        peg$c344 = { type: "class", value: "[a-zA-Z\\-_0-9]", description: "[a-zA-Z\\-_0-9]" },
        peg$c345 = function(headCharacters, headExpression, headOperator, bridgeValue, tailOperator, strengthAndWeight, tailCharacters) {
              return g.chainer({
        ...
        peg$c346 = function(operator, expression) {
            return g.headExpression(operator, expression);
          },
        peg$c347 = function(expression, operator) {
            return g.tailExpression(expression, operator);
          },
        peg$c348 = function() { return g.chainMathOperator().plus(); },
        peg$c349 = function() { return g.chainMathOperator().minus(); },
        peg$c350 = function() { return g.chainMathOperator().multiply(); },
        peg$c351 = function() { return g.chainMathOperator().divide(); },
        peg$c352 = function(operator) {
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    ...
                                    if (s16 !== peg$FAILED) {
                                      peg$reportedPos = s0;
                                      s1 = peg$c345(s1, s4, s6, s8, s10, s12, s15);
                                      s0 = s1;
                                    } else {
                                      peg$currPos = s0;
                                      s0 = peg$c0;
