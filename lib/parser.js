module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c252 = function(ups) {return [ups.join('')];},
        peg$c253 = "::document",
        ...
        peg$c271 = function(name, option) {
            if (option) {return ["$pseudo",name,option];}
            return ["$pseudo",name];
          },
        peg$c272 = /^[^)]/,
        peg$c273 = { type: "class", value: "[^)]", description: "[^)]" },
        peg$c274 = function(option) {return option.join(""); },
        peg$c275 = /^[^~|=!\^$&*\]]/,
        ...
        peg$c281 = function(left, op, right) {return ["$attribute",op.join(""),left.join("").trim(),right.join("").trim()]; },
        peg$c282 = function(attr) {return ["$attribute",attr.join("")]; },
        peg$c283 = function(name) {return name.join("")},
        peg$c284 = /^[a-zA-Z0-9\-_]/,
        peg$c285 = { type: "class", value: "[a-zA-Z0-9\\-_]", description: "[a-zA-Z0-9\\-_]" },
        peg$c286 = { type: "other", description: "Strength and Weight" },
        peg$c287 = "!",
        peg$c288 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c289 = function(strength, weight) {
            return g.strengthAndWeight().valid(strength, weight);
          },
        peg$c290 = function() {
            return g.strengthAndWeight().invalid();
          },
        peg$c291 = function(weight) { return Number(weight.join('')); },
        peg$c292 = "required",
        peg$c293 = { type: "literal", value: "required", description: "\"required\"" },
        peg$c294 = "REQUIRED",
        peg$c295 = { type: "literal", value: "REQUIRED", description: "\"REQUIRED\"" },
        peg$c296 = "Required",
        peg$c297 = { type: "literal", value: "Required", description: "\"Required\"" },
        peg$c298 = function() { return "require"; },
        peg$c299 = "require",
        peg$c300 = { type: "literal", value: "require", description: "\"require\"" },
        peg$c301 = "REQUIRE",
        peg$c302 = { type: "literal", value: "REQUIRE", description: "\"REQUIRE\"" },
        peg$c303 = "Require",
        peg$c304 = { type: "literal", value: "Require", description: "\"Require\"" },
        peg$c305 = "strong",
        peg$c306 = { type: "literal", value: "strong", description: "\"strong\"" },
        peg$c307 = "STRONG",
        peg$c308 = { type: "literal", value: "STRONG", description: "\"STRONG\"" },
        peg$c309 = "Strong",
        peg$c310 = { type: "literal", value: "Strong", description: "\"Strong\"" },
        peg$c311 = function() { return "strong"; },
        peg$c312 = "medium",
        peg$c313 = { type: "literal", value: "medium", description: "\"medium\"" },
        peg$c314 = "MEDIUM",
        peg$c315 = { type: "literal", value: "MEDIUM", description: "\"MEDIUM\"" },
        peg$c316 = "Medium",
        peg$c317 = { type: "literal", value: "Medium", description: "\"Medium\"" },
        peg$c318 = function() { return "medium"; },
        peg$c319 = "weak",
        peg$c320 = { type: "literal", value: "weak", description: "\"weak\"" },
        peg$c321 = "WEAK",
        peg$c322 = { type: "literal", value: "WEAK", description: "\"WEAK\"" },
        peg$c323 = "Weak",
        peg$c324 = { type: "literal", value: "Weak", description: "\"Weak\"" },
        peg$c325 = function() { return "weak"; },
        peg$c326 = /^[a-zA-Z\-_]/,
        peg$c327 = { type: "class", value: "[a-zA-Z\\-_]", description: "[a-zA-Z\\-_]" },
        peg$c328 = function(strength) { return strength.join('').toLowerCase(); },
        peg$c329 = "-gss-virtual",
        peg$c330 = { type: "literal", value: "-gss-virtual", description: "\"-gss-virtual\"" },
        peg$c331 = "virtual",
        peg$c332 = { type: "literal", value: "virtual", description: "\"virtual\"" },
        peg$c333 = function(names) {
        ...
        peg$c337 = function(variables) {
              return g.stay(variables);
            },
        peg$c338 = function(variable) { return g.stayVariable(variable); },
        peg$c339 = "@-gss-stay",
        peg$c340 = { type: "literal", value: "@-gss-stay", description: "\"@-gss-stay\"" },
        peg$c341 = "@stay",
        peg$c342 = { type: "literal", value: "@stay", description: "\"@stay\"" },
        peg$c343 = function(type, selector, javaScript) {
        ...
        peg$c348 = function(characters) { return g.javaScript(characters); },
        peg$c349 = "@-gss-for-each",
        peg$c350 = { type: "literal", value: "@-gss-for-each", description: "\"@-gss-for-each\"" },
        peg$c351 = "@for-each",
        peg$c352 = { type: "literal", value: "@for-each", description: "\"@for-each\"" },
        peg$c353 = function() { return g.forLoopType().forEach(); },
        peg$c354 = "@-gss-for-all",
        peg$c355 = { type: "literal", value: "@-gss-for-all", description: "\"@-gss-for-all\"" },
        peg$c356 = "@for-all",
        peg$c357 = { type: "literal", value: "@for-all", description: "\"@for-all\"" },
        peg$c358 = function() { return g.forLoopType().forAll(); },
        peg$c359 = "-gss-",
        peg$c360 = { type: "literal", value: "-gss-", description: "\"-gss-\"" },
        peg$c361 = "chain",
        peg$c362 = { type: "literal", value: "chain", description: "\"chain\"" },
        peg$c363 = function(selector, chainers) { //sw:StrengthAndWeight?
            return g.chain(selector, chainers);
          },
        peg$c364 = /^[a-zA-Z\-_0-9]/,
        peg$c365 = { type: "class", value: "[a-zA-Z\\-_0-9]", description: "[a-zA-Z\\-_0-9]" },
        peg$c366 = function(headCharacters, headExpression, headOperator, bridgeValue, tailOperator, strengthAndWeight, tailCharacters) {
              return g.chainer({
        ...
        peg$c367 = function(operator, expression) {
            return g.headExpression(operator, expression);
          },
        peg$c368 = function(expression, operator) {
            return g.tailExpression(expression, operator);
          },
        peg$c369 = function() { return g.chainMathOperator().plus(); },
        peg$c370 = function() { return g.chainMathOperator().minus(); },
        peg$c371 = function() { return g.chainMathOperator().multiply(); },
        peg$c372 = function() { return g.chainMathOperator().divide(); },
        peg$c373 = function(operator) {
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    ...
                                    if (s16 !== peg$FAILED) {
                                      peg$reportedPos = s0;
                                      s1 = peg$c366(s1, s4, s6, s8, s10, s12, s15);
                                      s0 = s1;
                                    } else {
                                      peg$currPos = s0;
                                      s0 = peg$c0;
