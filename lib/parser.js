module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c179 = function(weight) { return g.weight(weight); },
        peg$c180 = "required",
        ...
        peg$c186 = function() { return g.strength().required(); },
        peg$c187 = "require",
        ...
        peg$c193 = function() { return g.strength().require(); },
        peg$c194 = "strong",
        peg$c195 = { type: "literal", value: "strong", description: "\"strong\"" },
        peg$c196 = "STRONG",
        peg$c197 = { type: "literal", value: "STRONG", description: "\"STRONG\"" },
        peg$c198 = "Strong",
        peg$c199 = { type: "literal", value: "Strong", description: "\"Strong\"" },
        peg$c200 = function() { return g.strength().strong(); },
        peg$c201 = "medium",
        peg$c202 = { type: "literal", value: "medium", description: "\"medium\"" },
        peg$c203 = "MEDIUM",
        peg$c204 = { type: "literal", value: "MEDIUM", description: "\"MEDIUM\"" },
        peg$c205 = "Medium",
        peg$c206 = { type: "literal", value: "Medium", description: "\"Medium\"" },
        peg$c207 = function() { return g.strength().medium(); },
        peg$c208 = "weak",
        peg$c209 = { type: "literal", value: "weak", description: "\"weak\"" },
        peg$c210 = "WEAK",
        peg$c211 = { type: "literal", value: "WEAK", description: "\"WEAK\"" },
        peg$c212 = "Weak",
        peg$c213 = { type: "literal", value: "Weak", description: "\"Weak\"" },
        peg$c214 = function() { return g.strength().weak(); },
        peg$c215 = "@",
        peg$c216 = { type: "literal", value: "@", description: "\"@\"" },
        peg$c217 = "-gss-virtual",
        peg$c218 = { type: "literal", value: "-gss-virtual", description: "\"-gss-virtual\"" },
        peg$c219 = "virtual",
        peg$c220 = { type: "literal", value: "virtual", description: "\"virtual\"" },
        peg$c221 = function(names) {
            return g.virtualElement(names);
          },
        peg$c222 = "\"",
        peg$c223 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c224 = function(nameCharacters) {
            return g.virtualElementName(nameCharacters);
          },
        peg$c225 = function(variables) {
              return g.stay(variables);
            },
        peg$c226 = ",",
        peg$c227 = { type: "literal", value: ",", description: "\",\"" },
        peg$c228 = function(variable) { return g.stayVariable(variable); },
        peg$c229 = "@-gss-stay",
        peg$c230 = { type: "literal", value: "@-gss-stay", description: "\"@-gss-stay\"" },
        peg$c231 = "@stay",
        peg$c232 = { type: "literal", value: "@stay", description: "\"@stay\"" },
        peg$c233 = "@cond",
        peg$c234 = { type: "literal", value: "@cond", description: "\"@cond\"" },
        peg$c235 = function(result) { return g.conditional(result); },
        peg$c236 = function(type, selector, javaScript) {
        ...
        peg$c241 = function(characters) { return g.javaScript(characters); },
        peg$c242 = "@-gss-for-each",
        peg$c243 = { type: "literal", value: "@-gss-for-each", description: "\"@-gss-for-each\"" },
        peg$c244 = "@for-each",
        peg$c245 = { type: "literal", value: "@for-each", description: "\"@for-each\"" },
        peg$c246 = function() { return g.forLoopType().forEach(); },
        peg$c247 = "@-gss-for-all",
        peg$c248 = { type: "literal", value: "@-gss-for-all", description: "\"@-gss-for-all\"" },
        peg$c249 = "@for-all",
        peg$c250 = { type: "literal", value: "@for-all", description: "\"@for-all\"" },
        peg$c251 = function() { return g.forLoopType().forAll(); },
        peg$c252 = "-gss-",
        peg$c253 = { type: "literal", value: "-gss-", description: "\"-gss-\"" },
        peg$c254 = "chain",
        peg$c255 = { type: "literal", value: "chain", description: "\"chain\"" },
        peg$c256 = function(selector, chainers) { //sw:StrengthAndWeight?
            g.chain(selector, chainers);
          },
        peg$c257 = /^[a-zA-Z\-_0-9]/,
        peg$c258 = { type: "class", value: "[a-zA-Z\\-_0-9]", description: "[a-zA-Z\\-_0-9]" },
        peg$c259 = function(headCharacters, headExpression, headOperator, bridgeValue, tailOperator, strengthAndWeight, tailCharacters) {
              return g.chainer({
        ...
        peg$c260 = function(operator, expression) {
            return g.headExpression(operator, expression);
          },
        peg$c261 = function(expression, operator) {
            return g.tailExpression(expression, operator);
          },
        peg$c262 = function() { return g.chainMathOperator().plus(); },
        peg$c263 = function() { return g.chainMathOperator().minus(); },
        peg$c264 = function() { return g.chainMathOperator().multiply(); },
        peg$c265 = function() { return g.chainMathOperator().divide(); },
        peg$c266 = function(operator) {
                              ...
                              if (s13 !== peg$FAILED) {
                                ...
                                if (s14 !== peg$FAILED) {
                                  ...
                                  if (s15 !== peg$FAILED) {
                                    ...
                                    if (s16 !== peg$FAILED) {
                                      peg$reportedPos = s0;
                                      s1 = peg$c259(s1, s4, s6, s8, s10, s12, s15);
                                      s0 = s1;
                                    } else {
                                      peg$currPos = s0;
                                      s0 = peg$c0;
