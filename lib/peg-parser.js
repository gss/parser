module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c119 = function(funcs, sw) {return {commands:[funcs.concat([['strength'].concat(sw)])]};},
        peg$c120 = function(func, sw) {return {commands:[[func, ['strength'].concat(sw)]]};},
        peg$c121 = function(funcs) {return {commands:[funcs]};},
        peg$c122 = /^[a-zA-Z\-]/,
        peg$c123 = { type: "class", value: "[a-zA-Z\\-]", description: "[a-zA-Z\\-]" },
        peg$c124 = function(name) {return [name.join('')];},
        peg$c125 = function(name, param) {return [name.join(''), param];},
        peg$c126 = function(name, params) {return [name.join('')].concat(params);},
        ...
        peg$c130 = function(op, e) {return [op,e]},
        peg$c131 = "- ",
        ...
        peg$c145 = "undefined",
        peg$c146 = { type: "literal", value: "undefined", description: "\"undefined\"" },
        peg$c147 = function() {return undefined;},
        peg$c148 = function(exp, u) {
            return [u, exp];
          },
    ...
    function peg$parseAnonymousStatement() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseFuncSequence();
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseStrengthAndWeight();
          if (s3 !== peg$FAILED) {
            peg$reportedPos = s0;
            s1 = peg$c119(s1, s3);
            s0 = s1;
