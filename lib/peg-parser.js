module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c222 = function(filters) { if (filters.length === 1 ) {return filters[0];} return filters;},
        ...
        peg$c284 = function(option) {return option; },
        peg$c285 = function(n) {return Number(n.join(""));},
        peg$c286 = /^[^)]/,
        peg$c287 = { type: "class", value: "[^)]", description: "[^)]" },
        peg$c288 = function(string) {return string.join(""); },
        peg$c289 = /^[^~|=!\^$&*\]]/,
        ...
        peg$c295 = function(left, op, right) {return ["["+op.join("")+"]",left.join("").trim(),right.join("").trim()]; },
        peg$c296 = function(attr) {return ["[]",attr.join("")]; },
        peg$c297 = /^[^0-9\-]/,
        peg$c298 = { type: "class", value: "[^0-9\\-]", description: "[^0-9\\-]" },
        peg$c299 = function(name) {return name.join("")},
        peg$c300 = { type: "other", description: "Strength and Weight" },
        peg$c301 = "!",
        peg$c302 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c303 = function(strength, weight) {
            return g.strengthAndWeight().valid(strength, weight);
          },
        peg$c304 = function() {
            return g.strengthAndWeight().invalid();
          },
        peg$c305 = function(weight) { return Number(weight.join('')); },
        peg$c306 = "required",
        peg$c307 = { type: "literal", value: "required", description: "\"required\"" },
        peg$c308 = "REQUIRED",
        peg$c309 = { type: "literal", value: "REQUIRED", description: "\"REQUIRED\"" },
        peg$c310 = "Required",
        peg$c311 = { type: "literal", value: "Required", description: "\"Required\"" },
        peg$c312 = function() { return "require"; },
        peg$c313 = "require",
        peg$c314 = { type: "literal", value: "require", description: "\"require\"" },
        peg$c315 = "REQUIRE",
        peg$c316 = { type: "literal", value: "REQUIRE", description: "\"REQUIRE\"" },
        peg$c317 = "Require",
        peg$c318 = { type: "literal", value: "Require", description: "\"Require\"" },
        peg$c319 = "strong",
        peg$c320 = { type: "literal", value: "strong", description: "\"strong\"" },
        peg$c321 = "STRONG",
        peg$c322 = { type: "literal", value: "STRONG", description: "\"STRONG\"" },
        peg$c323 = "Strong",
        peg$c324 = { type: "literal", value: "Strong", description: "\"Strong\"" },
        peg$c325 = function() { return "strong"; },
        peg$c326 = "medium",
        peg$c327 = { type: "literal", value: "medium", description: "\"medium\"" },
        peg$c328 = "MEDIUM",
        peg$c329 = { type: "literal", value: "MEDIUM", description: "\"MEDIUM\"" },
        peg$c330 = "Medium",
        peg$c331 = { type: "literal", value: "Medium", description: "\"Medium\"" },
        peg$c332 = function() { return "medium"; },
        peg$c333 = "weak",
        peg$c334 = { type: "literal", value: "weak", description: "\"weak\"" },
        peg$c335 = "WEAK",
        peg$c336 = { type: "literal", value: "WEAK", description: "\"WEAK\"" },
        peg$c337 = "Weak",
        peg$c338 = { type: "literal", value: "Weak", description: "\"Weak\"" },
        peg$c339 = function() { return "weak"; },
        peg$c340 = /^[a-zA-Z\-_]/,
        peg$c341 = { type: "class", value: "[a-zA-Z\\-_]", description: "[a-zA-Z\\-_]" },
        peg$c342 = function(strength) { return strength.join('').toLowerCase(); },
        peg$c343 = "-gss-virtual",
        peg$c344 = { type: "literal", value: "-gss-virtual", description: "\"-gss-virtual\"" },
        peg$c345 = "virtual",
        peg$c346 = { type: "literal", value: "virtual", description: "\"virtual\"" },
        peg$c347 = function(names) {
        ...
        peg$c351 = function(variables) {
              return g.stay(variables);
            },
        peg$c352 = function(variable) { return g.stayVariable(variable); },
        peg$c353 = "@-gss-stay",
        peg$c354 = { type: "literal", value: "@-gss-stay", description: "\"@-gss-stay\"" },
        peg$c355 = "@stay",
        peg$c356 = { type: "literal", value: "@stay", description: "\"@stay\"" },
