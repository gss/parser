module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c186 = function(u) {return u.join('');},
        peg$c187 = /^[0-9]/,
        ...
        peg$c226 = function(head, tail) { return g.createSelectorCommaCommand(head, tail); },
        peg$c227 = function(filters) { if (filters.length === 1 ) {return filters[0];} return filters;},
        peg$c228 = { type: "other", description: "NoParanSelector" },
        peg$c229 = { type: "other", description: "SimpleSelector" },
        peg$c230 = function(c) {return [c]},
        peg$c231 = { type: "other", description: "Combinator" },
        peg$c232 = /^[><+~!]/,
        peg$c233 = { type: "class", value: "[><+~!]", description: "[><+~!]" },
        peg$c234 = function(c) {return c.join('');},
        peg$c235 = /^[^{,)]/,
        ...
        peg$c248 = function(name) {return g.splatifyIfNeeded('virtual',name);},
        peg$c249 = /^[^"]/,
        peg$c250 = { type: "class", value: "[^\"]", description: "[^\"]" },
        peg$c251 = function(name) {return name.join("");},
        peg$c252 = function(name) {return ["tag",name];},
        peg$c253 = function() {return ["tag", "*"];},
        peg$c254 = "#",
        peg$c255 = { type: "literal", value: "#", description: "\"#\"" },
        peg$c256 = function(name) {return g.splatifyIfNeeded('#',name);},
        peg$c257 = function(name) {return g.splatifyIfNeeded('.',name);},
        ...
        peg$c270 = "::document",
        peg$c271 = { type: "literal", value: "::document", description: "\"::document\"" },
        peg$c272 = "::host",
        peg$c273 = { type: "literal", value: "::host", description: "\"::host\"" },
        peg$c274 = "::scope",
        peg$c275 = { type: "literal", value: "::scope", description: "\"::scope\"" },
        peg$c276 = "::parent",
        peg$c277 = { type: "literal", value: "::parent", description: "\"::parent\"" },
        peg$c278 = "::window",
        peg$c279 = { type: "literal", value: "::window", description: "\"::window\"" },
        peg$c280 = "::viewport",
        peg$c281 = { type: "literal", value: "::viewport", description: "\"::viewport\"" },
        peg$c282 = function() { return "::window"; },
        peg$c283 = "::this",
        peg$c284 = { type: "literal", value: "::this", description: "\"::this\"" },
        peg$c285 = "::",
        peg$c286 = { type: "literal", value: "::", description: "\"::\"" },
        peg$c287 = function() { return "&"; },
        peg$c288 = function(colons, name, option) {
            if (option) {return [colons + name, option];}
            return [colons + name];
          },
        peg$c289 = function(option) {return option; },
        peg$c290 = function(n) {return Number(n.join(""));},
        peg$c291 = /^[^)]/,
        peg$c292 = { type: "class", value: "[^)]", description: "[^)]" },
        peg$c293 = function(string) {return string.join(""); },
        peg$c294 = /^[^~|=!\^$&*\]]/,
        ...
        peg$c300 = function(left, op, right) {return ["["+op.join("")+"]",left.join("").trim(),right.join("").trim()]; },
        peg$c301 = function(attr) {return ["[]",attr.join("")]; },
        peg$c302 = /^[^0-9\-]/,
        peg$c303 = { type: "class", value: "[^0-9\\-]", description: "[^0-9\\-]" },
        peg$c304 = function(name) {return name.join("")},
        peg$c305 = { type: "other", description: "Strength and Weight" },
        peg$c306 = "!",
        peg$c307 = { type: "literal", value: "!", description: "\"!\"" },
        peg$c308 = function(strength, weight) {
            return g.strengthAndWeight().valid(strength, weight);
          },
        peg$c309 = function() {
            return g.strengthAndWeight().invalid();
          },
        peg$c310 = function(weight) { return Number(weight.join('')); },
        peg$c311 = "required",
        peg$c312 = { type: "literal", value: "required", description: "\"required\"" },
        peg$c313 = "REQUIRED",
        peg$c314 = { type: "literal", value: "REQUIRED", description: "\"REQUIRED\"" },
        peg$c315 = "Required",
        peg$c316 = { type: "literal", value: "Required", description: "\"Required\"" },
        peg$c317 = function() { return "require"; },
        peg$c318 = "require",
        peg$c319 = { type: "literal", value: "require", description: "\"require\"" },
        peg$c320 = "REQUIRE",
        peg$c321 = { type: "literal", value: "REQUIRE", description: "\"REQUIRE\"" },
        peg$c322 = "Require",
        peg$c323 = { type: "literal", value: "Require", description: "\"Require\"" },
        peg$c324 = "strong",
        peg$c325 = { type: "literal", value: "strong", description: "\"strong\"" },
        peg$c326 = "STRONG",
        peg$c327 = { type: "literal", value: "STRONG", description: "\"STRONG\"" },
        peg$c328 = "Strong",
        peg$c329 = { type: "literal", value: "Strong", description: "\"Strong\"" },
        peg$c330 = function() { return "strong"; },
        peg$c331 = "medium",
        peg$c332 = { type: "literal", value: "medium", description: "\"medium\"" },
        peg$c333 = "MEDIUM",
        peg$c334 = { type: "literal", value: "MEDIUM", description: "\"MEDIUM\"" },
        peg$c335 = "Medium",
        peg$c336 = { type: "literal", value: "Medium", description: "\"Medium\"" },
        peg$c337 = function() { return "medium"; },
        peg$c338 = "weak",
        peg$c339 = { type: "literal", value: "weak", description: "\"weak\"" },
        peg$c340 = "WEAK",
        peg$c341 = { type: "literal", value: "WEAK", description: "\"WEAK\"" },
        peg$c342 = "Weak",
        peg$c343 = { type: "literal", value: "Weak", description: "\"Weak\"" },
        peg$c344 = function() { return "weak"; },
        peg$c345 = /^[a-zA-Z\-_]/,
        peg$c346 = { type: "class", value: "[a-zA-Z\\-_]", description: "[a-zA-Z\\-_]" },
        peg$c347 = function(strength) { return strength.join('').toLowerCase(); },
        peg$c348 = "-gss-virtual",
        peg$c349 = { type: "literal", value: "-gss-virtual", description: "\"-gss-virtual\"" },
        peg$c350 = "virtual",
        peg$c351 = { type: "literal", value: "virtual", description: "\"virtual\"" },
        peg$c352 = function(names) {
        ...
        peg$c356 = function(variables) {
              return g.stay(variables);
            },
        peg$c357 = function(variable) { return g.stayVariable(variable); },
        peg$c358 = "@-gss-stay",
        peg$c359 = { type: "literal", value: "@-gss-stay", description: "\"@-gss-stay\"" },
        peg$c360 = "@stay",
        peg$c361 = { type: "literal", value: "@stay", description: "\"@stay\"" },
    ...
    function peg$parseVirtual() {
      ...
      if (s1 !== peg$FAILED) {
        if (input.substr(peg$currPos, 12) === peg$c348) {
          s2 = peg$c348;
          peg$currPos += 12;
        } else {
          s2 = peg$FAILED;
