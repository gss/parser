var analyze, expand2dProperties, propertyMapping, _analyze, _changePropertyName, _clone,
  _this = this;
...
_analyze = function(node, commands, firstLevelCmd, expandObjs) {
  var clonedNode, commandName, headNode, i, sub, tailNode, _i, _len, _ref;
  if (node.length >= 3) {
    commandName = node[0];
    headNode = node[1];
    tailNode = node[2];
    ...
    if (commandName === 'rule') {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        if (sub instanceof Array) {
          ...
          if ((sub.has2dProperty != null) && sub.has2dProperty) {
            expandObjs.push({
              toExpand: {
                parent: tailNode,
                twodnode: sub
      ...
      if ((node.has2dProperty != null) === false || !node.has2dProperty) {
        node.has2dProperty = ((headNode.has2dProperty != null) && headNode.has2dProperty === true) || ((tailNode.has2dProperty != null) && tailNode.has2dProperty === true);
      }
